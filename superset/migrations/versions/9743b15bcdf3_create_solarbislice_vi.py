...
# under the License.
"""create SolarBISlice VI

Revision ID: 9743b15bcdf3
Revises: c0976562b775
Create Date: 2019-09-25 11:28:47.027122

"""

# revision identifiers, used by Alembic.
revision = '9743b15bcdf3'
down_revision = 'c0976562b775'
...
def upgrade():
    ...
    #            existing_type=sa.DATETIME(),
    #            nullable=True)
    op.add_column('solarbi_slices', sa.Column('changed_by_fk', sa.Integer(), nullable=True))
    op.add_column('solarbi_slices', sa.Column('changed_on', sa.DateTime(), nullable=True))
    op.add_column('solarbi_slices', sa.Column('created_by_fk', sa.Integer(), nullable=True))
    op.add_column('solarbi_slices', sa.Column('created_on', sa.DateTime(), nullable=True))
...
def downgrade():
    ...
    op.drop_constraint(None, 'solarbi_slices', type_='foreignkey')
    op.drop_column('solarbi_slices', 'created_on')
    op.drop_column('solarbi_slices', 'created_by_fk')
    op.drop_column('solarbi_slices', 'changed_on')
    op.drop_column('solarbi_slices', 'changed_by_fk')
    # op.alter_column('slices', 'created_on',
    #            existing_type=sa.DATETIME(),
    #            nullable=False)
    # op.alter_column('slices', 'changed_on',
